# Discovery Studio 2019 — docking workspace

Branch: `tool/discovery-studio` · Owners: [UNASSIGNED] · Licence: commercial

Self-contained workspace for docking the canonical PAH panel into the canonical PahP receptor with
**Discovery Studio 2019**. Work in two steps, in this order:

## Step 1 — `preprocessing/`
State **exactly** what preparation Discovery Studio 2019 needs and do it. Fill
...
|--------|----------------|-----------|
| `inputs/` | canonical inputs converted to Discovery Studio 2019 formats | **yes** (committed so it can be reviewed) |
...
- Touch only this folder (`tools/discovery-studio/`) — not another tool's workspace.
