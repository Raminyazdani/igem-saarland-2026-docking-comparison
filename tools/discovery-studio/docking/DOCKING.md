...
- Score direction: _TODO_ (`lower_is_better` or `higher_is_better` for Discovery Studio 2019)

## Output of this step
1. Native results + logs → `../outputs/`
2. Final chosen poses → `../results/poses/` named `PahP__<ligand>__discovery-studio__v1.<ext>`
