#!/usr/bin/env bash
# Docking run for Discovery Studio 2019 (tool/discovery-studio).
...
echo "[discovery-studio] docking with config: $CONFIG"
...
echo "TODO: run Discovery Studio 2019 for each ligand -> $OUTPUTS/"

echo "[discovery-studio] docking done. Next: pick poses -> ../results/poses/, fill ../results/DOCKING_RESULT.json, validate."
