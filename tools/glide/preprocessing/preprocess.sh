...
#
# If Glide (Schrodinger) is GUI/web-only and cannot be scripted, leave this as documentation and
...
echo "[glide] preprocessing done. Now fill PREPROCESSING.yaml and run ../docking/run_docking.sh"
