...
- Score direction: _TODO_ (`lower_is_better` or `higher_is_better` for Glide (Schrodinger))

## Output of this step
1. Native results + logs → `../outputs/`
2. Final chosen poses → `../results/poses/` named `PahP__<ligand>__glide__v1.<ext>`
