# Glide (Schrodinger) — docking workspace

Branch: `tool/glide` · Owners: [Ramin] · Licence: commercial

Self-contained workspace for docking the canonical PAH panel into the canonical PahP receptor with
**Glide (Schrodinger)**. Work in two steps, in this order:

## Step 1 — `preprocessing/`
State **exactly** what preparation Glide (Schrodinger) needs and do it. Fill
...
|--------|----------------|-----------|
| `inputs/` | canonical inputs converted to Glide (Schrodinger) formats | **yes** (committed so it can be reviewed) |
...
- Touch only this folder (`tools/glide/`) — not another tool's workspace.
