# Preprocessing — {{TOOL_NAME}}

**Goal of this step:** state *exactly* what preparation {{TOOL_NAME}} needs to turn the shared canonical
...
- Necessary steps for {{TOOL_NAME}}: _TODO_ (signal peptide? protonation? charges? format?).
- What I did: _TODO_.

### Ligands
- Source: `input/canonical/ligands/ligands.sdf` (shared 3D conformers).
- Necessary steps for {{TOOL_NAME}}: _TODO_.
