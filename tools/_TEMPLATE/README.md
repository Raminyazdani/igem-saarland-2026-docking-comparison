# {{TOOL_NAME}} — docking workspace

Branch: `{{BRANCH}}` · Owners: {{OWNERS}} · Licence: {{LICENCE}}

Self-contained workspace for docking the canonical PAH panel into the canonical PahP receptor with
**{{TOOL_NAME}}**. Work in two steps, in this order:

## Step 1 — `preprocessing/`
State **exactly** what preparation {{TOOL_NAME}} needs and do it. Fill
...
|--------|----------------|-----------|
| `inputs/` | canonical inputs converted to {{TOOL_NAME}} formats | **yes** (committed so it can be reviewed) |
...
- Touch only this folder (`tools/{{SLUG}}/`) — not another tool's workspace.
