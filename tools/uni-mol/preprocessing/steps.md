# Preprocessing — Uni-Mol Docking

**Goal of this step:** state *exactly* what preparation Uni-Mol Docking needs to turn the shared canonical
...
- Necessary steps for Uni-Mol Docking: _TODO_ (signal peptide? protonation? charges? format?).
- What I did: _TODO_.

### Ligands
- Source: `input/canonical/ligands/ligands.sdf` (shared 3D conformers).
- Necessary steps for Uni-Mol Docking: _TODO_.
