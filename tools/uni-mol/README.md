# Uni-Mol Docking — docking workspace

Branch: `tool/uni-mol` · Owners: [Elnaz, Sadaf] · Licence: free

Self-contained workspace for docking the canonical PAH panel into the canonical PahP receptor with
**Uni-Mol Docking**. Work in two steps, in this order:

## Step 1 — `preprocessing/`
State **exactly** what preparation Uni-Mol Docking needs and do it. Fill
...
|--------|----------------|-----------|
| `inputs/` | canonical inputs converted to Uni-Mol Docking formats | **yes** (committed so it can be reviewed) |
...
- Touch only this folder (`tools/uni-mol/`) — not another tool's workspace.
