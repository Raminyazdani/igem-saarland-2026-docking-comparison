# Preprocessing — GOLD (CCDC)

**Goal of this step:** state *exactly* what preparation GOLD (CCDC) needs to turn the shared canonical
...
- Necessary steps for GOLD (CCDC): _TODO_ (signal peptide? protonation? charges? format?).
- What I did: _TODO_.

### Ligands
- Source: `input/canonical/ligands/ligands.sdf` (shared 3D conformers).
- Necessary steps for GOLD (CCDC): _TODO_.
