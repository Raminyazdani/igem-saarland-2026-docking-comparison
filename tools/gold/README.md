# GOLD (CCDC) — docking workspace

Branch: `tool/gold` · Owners: [Moulya] · Licence: commercial

Self-contained workspace for docking the canonical PAH panel into the canonical PahP receptor with
**GOLD (CCDC)**. Work in two steps, in this order:

## Step 1 — `preprocessing/`
State **exactly** what preparation GOLD (CCDC) needs and do it. Fill
...
|--------|----------------|-----------|
| `inputs/` | canonical inputs converted to GOLD (CCDC) formats | **yes** (committed so it can be reviewed) |
...
- Touch only this folder (`tools/gold/`) — not another tool's workspace.
